...
<div class="w-full max-w-2xl pt-10 text-left px-6">
  <h1 class="text-xl font-semibold text-gray-900 sm:text-xl text-left">Edit Note</h1>
        ...
        <div class="col-span-full">
          ...
          <?php if (isset($errors['body'])): ?>
           ...
           <div class="mt-6 flex items-center justify-end gap-x-6">
            <a href="/notes"
           class="rounded-md bg-gray-500 px-3 py-2 text-sm font-semibold text-white shadow-xs hover:bg-gray-600 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-gray-500"> cancel
            </a>
